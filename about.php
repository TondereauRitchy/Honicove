...
<body class="about-page">
  ...
  <main class="wrap">
    <!-- ABOUT HEADER -->
      ...
      <!-- New media block: two images with a paragraph between and one after the second image -->
      <div class="about-media">
        <img src="logo/image1.jpg" alt="Honicove photo 1" class="about-media-img">
        <p class="about-media-text">Notre atelier allie un savoir‑faire traditionnel à des procédés de fabrication modernes pour garantir, à chaque étape, une qualité irréprochable et une durabilité réelle. Nous choisissons prioritairement des matières recyclées et certifiées, contrôlons les coupes et les finitions avec minutie, et testons les prototypes en situation réelle pour valider tenue, confort et résistance. En favorisant les petites séries et les circuits courts, nous minimisons le gaspillage et optimisons la traçabilité. Ce travail réfléchi permet de proposer des vêtements faits pour durer, faciles à réparer et pensés pour réduire l’empreinte environnementale tout en conservant une esthétique épurée et contemporaine.</p>
        <img src="logo/image2.jpg" alt="Honicove photo 2" class="about-media-img">
        <p class="about-media-text">Chaque pièce Honicove est conçue pour s’intégrer simplement à votre quotidien : finitions soignées, matières responsables et un design polyvalent qui va du studio à la ville. Nos équipes effectuent des contrôles qualité stricts, proposent des options de retouche et mettent à disposition des guides d’entretien pour prolonger la vie des vêtements. Nous développons également un programme de réparation et de reprise afin d’encourager une consommation plus circulaire. En choisissant nos pièces, vous investissez dans une garde‑robe réduite, performante et durable, pensée pour accompagner vos saisons avec élégance et confort.</p>
      </div>
    </section>
  </main>
