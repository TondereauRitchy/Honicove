...
<head>
  ...
  <title>Thank You - Honicove</title>
...
<body>
  ...
  <header class="site-header">
    ...
    <nav class="main-nav" aria-label="Main navigation">
      <a href="#" onclick="toggleSearch(event)" aria-label="Search">
      ...
      <div class="account-container">
        <a href="#" onclick="toggleAccountDropdown(event)" aria-label="Account">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <main class="thank-you-container">
    ...
    <p class="thank-you-message">
      Your payment has been successfully processed. Thank you for shopping with Honicove!
    </p>
    <a href="index.php" class="thank-you-btn">Continue Shopping</a>
  </main>
  ...
  <script>
    ...
    // Cart modal functions (placeholder)
