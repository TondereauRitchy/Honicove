...
$router->resourceRoutes(new ProductRoutes());

// Enregistrer les routes des utilisateurs
...
use Routing\OrderRoutes;
$router->resourceRoutes(new OrderRoutes());
