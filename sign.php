...
<head>
  ...
  <title>Se connecter - Honicove</title>
...
<body class="sign-page">
  ...
  <main class="auth-layout" style="min-height:60vh;display:flex;align-items:center;justify-content:center;padding:40px 16px;">
    <div class="auth-card" style="width:100%;max-width:420px;background:#fff;border:1px solid #eee;border-radius:12px;padding:28px;box-shadow:0 6px 24px rgba(0,0,0,0.08);">
      <h1 style="margin:0 0 8px;font-size:24px;">Se connecter</h1>
      <p style="margin:0 0 20px;color:#666;">Accédez à votre compte Honicove</p>
      ...
      <form id="loginForm" method="post" style="display:flex;flex-direction:column;gap:14px;">
        ...
        <button type="submit" style="margin-top:6px;padding:12px 16px;background:#000;color:#fff;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Se connecter</button>
      </form>
    ...
    document.getElementById('loginForm').addEventListener('submit', async function(e) {
      ...
      try {
        ...
        if (result.error) {
          ...
          // Connexion réussie - créer une session côté serveur et rediriger
          // Appeler un endpoint pour établir la session
          ...
          // Supprimer les données sensibles de localStorage
